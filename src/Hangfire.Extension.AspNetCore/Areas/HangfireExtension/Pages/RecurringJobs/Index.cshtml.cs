...
namespace Hangfire.Extension.AspNetCore.Areas.HangfireExtension.Pages.RecurringJobs;

public sealed class IndexModel(IRecurringJobAdminService recurringJobAdminService) : PageModel
{
